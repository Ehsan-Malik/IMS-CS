...
if(isset($_GET['id'])){
$id=$_GET['id'];
$result=mysqli_query($conn,"SELECT * FROM notification WHERE id='$id'");
...
if(isset($_POST['update'])){
 $id=$_POST['Nid'];
 $nottype=$_POST['Nnottype'];
 $detail=$_POST['Ndetail'];

$up= $row['id'];
$update=mysqli_query($conn,"UPDATE notification SET id='$id',not_type='$nottype',not_detail='$detail' WHERE id='$up'");
if($update){
...
<table style="text-align: center; margin: 0 auto; margin-top: 50px;">
  ...
  <td><input type="text" name="Nid" value="<?php echo $row['id'];?>"/></td>
  </tr>
  <tr>
     <td><span>Notification Type:*</span></td>
  <td>
  <input type="text" name="Nnottype" value="<?php echo $row['not_type'];?>"/></td>
  </tr>
  <tr>
     <td><span>Notification Detail:*</span></td>
  <td><input type="text" name="Ndetail" value="<?php echo $row['not_detail'];?>"/></td>
  </tr>
