...
if(empty($_POST['id'])| empty($_POST['detail'])){
 echo "* Marked Fields are Mandatory.";
}else{
 $id=$_POST['id'];
 $nottype=$_POST['nottype'];
 $detail=$_POST['detail'];

$query = "insert into notification values('$id','$nottype','$detail')";
...
<tr>
  ...
  <td> <br>
                        <input type="radio" name="nottype" value="Dept" />&nbsp;&nbsp;&nbsp;&nbsp;Department Notification
                    <br>
                    <br>
                        <input type="radio" name="nottype" value="Class" />&nbsp;&nbsp;&nbsp;&nbsp;Class Notification<br>
  </td>
  </tr>
  <tr>
