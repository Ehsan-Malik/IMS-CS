...
<tr>
  ...
  <td><input type="text" name="omarks"/></td>
  </tr>
  <tr>
...
if(empty($_POST['rollno'])| empty($_POST['omarks'])){
 ...
 $gpa=$_POST['gpa'];
 $cgpa=$_POST['cgpa'];
 $query = "insert into marks values('$rollno','$tmarks','$omarks','$percentage','$status','$gpa','$cgpa')";
 $result = mysqli_query($conn, $query);
 if($result){
    echo "Successfully Added";
}else{
 echo "Date and Roll no Already Exist ";
}
}
}
?>
