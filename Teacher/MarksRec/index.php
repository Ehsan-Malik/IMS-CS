...
<a href="create.php" id="add">Add Marks</a>
<br>
<br>
...
<table style="text-align: center; margin: 0 auto; margin-top: 50px;">
 ...
 <?php
$result=mysqli_query($conn,"SELECT * FROM marks ORDER BY rollno DESC");
while($row=$result->fetch_array()){?>
 ...
 <td><?php echo $row['cgpa'];?></td>
   <td><a href="update.php?rollno=<?php echo $row['rollno'];?>">Update</a></td>
