...
$records = mysqli_query($con,"select * from studenttimetable"); // fetch data from database
...
?>
  <tr>
    ...
    <td><img src="../../Itservice/Timetable/Student/upload/<?php echo $data['images']; ?>" width="800" height="400" style="padding: 20px;"></td>
  </tr>	
<?php
}
?>
