...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="col-sm-12 col-sm-offset-12 col-md-10 col-md-offset-2 main" style="padding-top: 70px;">
            ...
            <h2 style="text-align:center;">Time Tables</h2>
...
$records = mysqli_query($con,"select * from teachertimetable"); // fetch data from database
...
?>
  <tr>
    ...
    <td><img src="../../Itservice/Timetable/Teacher/upload/<?php echo $data['images']; ?>" width="800" height="400" style="padding: 20px;"></td>
  </tr>	
<?php
}
?>
