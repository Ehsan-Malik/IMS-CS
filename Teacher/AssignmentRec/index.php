...
<body>
  ...
  <div class="card-body">
    ...
    <p class="card-text">Is any Assigments are uploaded. You can upload it below.</p>
    <a href="http://localhost/IMS/Teacher/AssignmentRec/Upload" class="btn btn-primary">Upload New Assignment</a>
  </div>
...
<div class="card text-center" id="cardcenter">
  ...
  <div class="card-body">
    <h5 class="card-title">Students Submissions</h5>
    <p class="card-text">How may students Submit the Assignment. You can check it below.</p>
    <a href="http://localhost/IMS/Teacher/AssignmentRec/Check" class="btn btn-primary">Check Students Submissions</a>
  </div>
  <div class="card-footer text-muted" style="background-color:blue;">
