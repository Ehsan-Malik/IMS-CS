...
if(isset($_GET['id'])){
$id=$_GET['id'];
$result=mysqli_query($conn,"SELECT * FROM t_assignment WHERE id='$id'");
...
<table style="text-align: center; margin: 0 auto; margin-top: 50px;">
  ...
  <td><input type="date" name="deadline" value="<?php echo $row['deadline'];?>"/></td>
  </tr>
...
$ro=$row['id'];
$update=mysqli_query($conn,"UPDATE t_assignment SET id='$id',subject='$subject',deadline='$deadline',detail='$detail',class='$class' WHERE id='$ro'");
if($update){
