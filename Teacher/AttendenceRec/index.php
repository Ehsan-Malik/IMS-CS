...
<a href="create.php" id="add">Add Attendence</a>
<br>
<br>
...
<table style="text-align: center; margin: 0 auto; margin-top: 50px;">
 ...
 <?php
$result=mysqli_query($conn,"SELECT * FROM studentattend ORDER BY roll DESC");
while($row=$result->fetch_array()){?>
 ...
 <td><?php echo $row['roll'];?></td>
   <td><a href="update.php?roll=<?php echo $row['roll'];?>">Update</a></td>
  <td><a href="delete.php?roll=<?php echo $row['roll'];?>">Delete</a></td>
