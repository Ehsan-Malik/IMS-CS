...
if(isset($_GET['roll'])){
$roll=$_GET['roll'];
$result=mysqli_query($conn,"SELECT * FROM studentattend WHERE roll='$roll'");
...
<tr>
  ...
  <td><input type="date" name="Ndate" value="<?php echo $row['Date'];?>"/></td>
  </tr>
  <tr>
     <td><span>Subject:*</span></td>
  <td><input type="text" name="Nsubject" value="<?php echo $row['Subject'];?>"/></td>
  </tr>

  <tr>
     <td><span>Attendance:*</span></td>
  <td><input type="text" name="Nattendence" value="<?php echo $row['Attendence'];?>"/></td>
  </tr>
  ...
  <td><input type="text" name="Nroll" value="<?php echo $row['roll'];?>"/></td>
  </tr>
...
if(isset($_POST['update'])){
 ...
 $attendence=$_POST['Nattendence'];
$ro=$row['roll'];
 $update=mysqli_query($conn,"UPDATE studentattend SET roll='$roll',date='$date',subject='$subject',attendence='$attendence' WHERE roll='$ro'");
