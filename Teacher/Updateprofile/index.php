...
input[type=reset]{
    background-color: rgb(157 176 185 / 66%);
}
...
<body>
    ...
    <div class="wrapper">
        <div class="sidebar col -l2 -s4" style="left:0;">
            <ul>
                ...
                <li><a href="http://localhost/IMS/Teacher/"><i class="fas fa-clipboard"></i>Dashboard</a></li>
                <li><a href="http://localhost/IMS/Teacher/Updateprofile"><i class="fas fa-user-edit"></i> Update Profile</a></li>
                <li><a href="http://localhost/IMS/Teacher/Timetable"><i class="fas fa-pen"></i>Time Table</a></li>
                <li><a href="http://localhost/IMS/Teacher/Notification"><i class="far fa-file"></i> Notifications</a></li>
                <li><a href="http://localhost/IMS/Teacher/AttendenceRec"><i class="fas fa-user-edit"></i> Attendance</a></li>
                <li><a href="http://localhost/IMS/Teacher/MarksRec"><i class="fas fa-clipboard"></i>Marks Record</a></li>
                <li><a href="http://localhost/IMS/Teacher/FeeRec"><i class="far fa-file"></i> Fee Record</a></li>
                <li><a href="http://localhost/IMS/Teacher/StdRecord"><i class="fas fa-clipboard"></i>Students Record</a></li>
                <li><a href="http://localhost/IMS/Teacher/ExamRec"><i class="far fa-file"></i> Exam Record</a></li>
                <li><a href="http://localhost/IMS/Teacher/SalaryRec"><i class="fas fa-user-edit"></i> Salary Record</a></li>
                <li><a href="http://localhost/IMS/Teacher/AssignmentRec"><i class="fas fa-user-edit"></i> Assignment Record</a></li>

              </ul>
        </div>
        <div class="col-sm-12 col-sm-offset-12 col-md-10 col-md-offset-2 main" style="padding-top: 70px; margin:  0 auto; width: 80rem;">
            <!-- container-->

            <?php
    extract($_POST);
    if (isset($Update)) {
        $q = "UPDATE teacher set scardno= '$scardno',fname = '$fname',lname = '$lname',phno = '$phone',cnic='$cnic',email='$email' where usn = '$user'";
        $run = mysqli_query($conn, $q);
        $q = "UPDATE registration set scard= '$scardno',fname = '$fname',lname = '$lname',bdate = '$dob',phno = '$phone',cnic='$cnic',email='$email',question='$question',answer='$answer' where usn = '$user'";
        $run = mysqli_query($conn, $q);
        if ($run) {
    ...
    ?>
    <div class=" mcontainer" style="background-color:rgb(255 255 255);">
        <form name="register" method="post" class="myform" action="" enctype="multipart/form-data">
            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        <label style="  color: #1d02ff; margin: 1%; width: 100%; text-align: left; font-size: 20px; font-family: 'PT Serif';">Birth Date</label>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="email" name="email" autocomplete="off" placeholder="student.cs19@bmsce.ac.in" value="<?php echo $row['email']; ?>" />
                    </td>
                </tr>

                <tr>
                    <td>
                        <label style="  color: #1d02ff; margin: 1%; width: 100%; text-align: left; font-size: 20px; font-family: 'PT Serif';">Phone</label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <label class="required">Servic Card No</label>
                    </td>
                    <td>

                    </td>
                    <td class="td1">
                        <input type="text" name="scardno" value="<?php echo $row['scard']; ?>"  />
                    </td>
                </tr>
