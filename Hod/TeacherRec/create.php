    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="width: 100%;z-index:1;position:fixed;top:0;left:0;padding:8px;border:none;background-color:#5239aa;border-bottom:1px solid black;box-shadow: 3px 3px 5px black;">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand text-white" style="font-family:'Acme';font-size:30px;color: white;padding-right: 750px;" href="#">Welcome, <?php echo '' . $row['fname'] . ' ' . $row['lname']; ?> <?php echo '' . $row['fname'] . ' ' . $row['lname']; ?> </a>
...
<tr>
  ...
  <td><input type="text" name="scardno"/></td>
  </tr>
  <tr>
  ...
  <td><input type="cnic" name="cnic"/></td>
  </tr>
  <tr>
...
if(empty($_POST['fname'])| empty($_POST['email'])){
 ...
 $cat=$_POST['cat'];
 $query = "insert into registration values('','$fname','$lname','','$usn','$email','','$cnic','$scardno','','$phone','','$pass','$cat', '','', '', '', 'Teacher')";
 $result=mysqli_query($conn,$query);
 $query = "insert into teacher values('$scardno','$fname','$lname','$usn','$email','$cnic','$pass','$phone','$cat')";
 $result=mysqli_query($conn,$query);
 if($result){
