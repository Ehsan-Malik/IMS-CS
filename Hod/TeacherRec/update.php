...
if(isset($_GET['usn'])){
$usn=$_GET['usn'];
$result=mysqli_query($conn,"SELECT * FROM teacher WHERE usn='$usn'");
...
<table style="text-align: center; margin: 0 auto; margin-top: 50px;">
  ...
  <td><input type="text" name="Ncat" value="<?php echo $row['category'];?>"/></td>
  </tr>  
...
if(isset($_POST['update'])){
 ...
 $update=mysqli_query($conn,"UPDATE registration SET scard='$scardno',fname='$fname',lname='$lname',usn='$usn',email='$email',cnic='$cnic',password='$pass',phno='$phone',category='$cat' WHERE usn='$usn'");
$update=mysqli_query($conn,"UPDATE teacher SET scardno='$scardno',fname='$fname',lname='$lname',usn='$usn',email='$email',cnic='$cnic',password='$pass',phone='$phone',category='$cat' WHERE usn='$usn'");
if($update){
