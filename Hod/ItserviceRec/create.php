...
if(empty($_POST['fname'])| empty($_POST['email'])){
 ...
 $query = "insert into registration values('','$fname','$lname','','$usn','$email','','$cnic','$scard','','$phone','','$pass','$cat', '','', '', '', 'IT Services Staff')";
 $result=mysqli_query($conn,$query);


$query = "insert into itservice values('$scard','$fname','$lname','$usn','$pass','$email','$cnic','$cat','$phone')";
 $result=mysqli_query($conn,$query);
 if($result){
