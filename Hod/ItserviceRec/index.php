...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="col-sm-12 col-sm-offset-12 col-md-10 col-md-offset-2 main" style="padding-top: 70px;">
            ...
            <a href="create.php" id="add">Add New Member</a>
...
<table>
 ...
 <?php
 $result=mysqli_query($conn,"SELECT * FROM itservice ORDER BY scardno DESC");
 while($row=$result->fetch_array()){?>
  ...
  <td><?php echo $row['phone'];?></td>
   ...
   <td><a href="update.php?usn=<?php echo $row['usn'];?>">Update</a></td>
  <td><a href="delete.php?usn=<?php echo $row['usn'];?>">Delete</a></td>
