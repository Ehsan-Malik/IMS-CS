...
if(isset($_GET['usn'])){
$usn=$_GET['usn'];
$result=mysqli_query($conn,"SELECT * FROM student WHERE usn='$usn'");
...
<table style="text-align: center; margin: 0 auto; margin-top: 50px;">
  ...
  <td><input type="text" name="Nyear" value="<?php echo $row['year'];?>"/></td>
  </tr>  <tr>
     <td><span>Discipline:*</span></td>
  <td><input type="text" name="Ndisc" value="<?php echo $row['discipline'];?>"/></td>
  </tr>
  <tr>
     <td><span>Semester:*</span></td>
  <td><input type="text" name="Nsem" value="<?php echo $row['sem'];?>"/></td>
  </tr>
...
if(isset($_POST['update'])){
 ...
 $disc=$_POST['Ndisc'];
 $sem=$_POST['Nsem'];
 $update=mysqli_query($conn,"UPDATE registration SET roll='$rollno',fname='$fname',lname='$lname',usn='$usn',email='$email',password='$pass',cnic='$cnic',phno='$phone',discipline='$disc',sem='$sem' WHERE usn='$usn'");
$update=mysqli_query($conn,"UPDATE student SET rollno='$rollno',fname='$fname',lname='$lname',usn='$usn',email='$email',password='$pass',cnic='$cnic',phone='$phone',year='$year',discipline='$disc',sem='$sem' WHERE usn='$usn'");
if($update){
