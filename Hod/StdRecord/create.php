...
if(empty($_POST['fname'])| empty($_POST['email'])){
 ...
 $query = "insert into registration values('','$fname','$lname','','$usn','$email','$rollno','$cnic','','','$phone','','$pass','', '$disc','$sem','', '','Student')";
 $result = mysqli_query($conn, $query);

$query = "insert into student values('$rollno','$fname','$lname','$usn','$email','$pass','$cnic','$phone','$year','$disc','$sem')";
 $result=mysqli_query($conn,$query);

 if($result){
    echo "Successfully Added";
}else{
 echo "Username or Roll no Already Exist ";
}
}
}
?>
