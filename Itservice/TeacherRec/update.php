...
<head>
    ...
    <title>Edit Teachers Record.!</title>
...
$result=mysqli_query($conn,"SELECT * FROM teacher WHERE scardno='$scardno'");
...
$update=mysqli_query($conn,"UPDATE teacher SET scardno='$scardno',fname='$fname',lname='$lname',usn='$usn',email='$email',cnic='$cnic',password='$pass',phone='$phone',category='$cat' WHERE scardno='$scardno'");
if($update){
