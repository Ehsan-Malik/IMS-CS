...
if(empty($_POST['rollno'])| empty($_POST['submitted'])){
...
$query = "insert into feerecord values('$rollno','$totalfee','$submitted','$depositor','$ddf','$submission_date')";
...
<tr>
  ...
  <tr>
     <td><span>DDF :*</span></td>
  <td><input type="text" name="ddf"/></td>
  </tr>
  <tr>
