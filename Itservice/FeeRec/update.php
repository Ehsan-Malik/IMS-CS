...
$rollno=$_GET['rollno'];
$result=mysqli_query($conn,"SELECT * FROM feerecord WHERE rollno='$rollno'");
...
if(isset($_POST['update'])){
 ...
 $totalfee=$_POST['Ntotalfee'];
 $submitted=$_POST['Nsubmitted'];
 $depositor=$_POST['Ndepositor'];
 $ddf=$_POST['Nddf'];
 $submission_date=$_POST['Nsubmission_date'];

$ro=$row['rollno'];
$update=mysqli_query($conn,"UPDATE feerecord SET rollno='$rollno',totalfee='$totalfee',submitted='$submitted',depositor='$depositor',ddf='$ddf',submission_date='$submission_date' WHERE rollno='$ro'");
if($update){
...
<table style="text-align:center; margin: 0 auto; margin-top: 100px;">
  <tr>
  ...
  <td>
  <input type="text" name="Ntotalfee" value="<?php echo $row['totalfee'];?>"/></td>
  </tr>
  <tr>
     <td><span>Submitted Fee:*</span></td>
  <td><input type="text" name="Nsubmitted" value="<?php echo $row['submitted'];?>"/></td>
  </tr>

  <tr>
     <td><span>Depositor :*</span></td>
  <td><input type="text" name="Ndepositor" value="<?php echo $row['depositor'];?>"/></td>
  </tr>
  <tr>
     <td><span>DDF:*</span></td>
  <td>
  <input type="text" name="Nddf" value="<?php echo $row['ddf'];?>"/></td>
  </tr>
  <tr>
     <td><span>Submission Date:*</span></td>
  <td><input type="text" name="Nsubmission_date" value="<?php echo $row['submission_date'];?>"/></td>
  </tr>
