...
if(empty($_POST['rollno'])| empty($_POST['session'])){
...
$query = "insert into examrecord values('$rollno','$session',' $teacher_remarks','$student_feedback')";
...
<tr>
  ...
  <td><input type="text" name="student_feedback"/></td>
  </tr>
  <tr>
     <td></td>
