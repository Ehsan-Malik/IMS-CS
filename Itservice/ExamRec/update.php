...
$rollno=$_GET['rollno'];
$result=mysqli_query($conn,"SELECT * FROM examrecord WHERE rollno='$rollno'");
...
if(isset($_POST['update'])){
 ...
 $teacher_remarks=$_POST['Nteacher_remarks'];
 $student_feedback=$_POST['Nstudent_feedback'];
$ro=$row['rollno'];
$update=mysqli_query($conn,"UPDATE examrecord SET rollno='$rollno',session='$session',teacher_remarks='$teacher_remarks', student_feedback='$student_feedback' WHERE rollno='$ro'");
if($update){
...
<table style="text-align: ceter; margin: 0 auto; margin-top:50px;">
  ...
  <td>
  <input type="text" name="Nsession" value="<?php echo $row['session'];?>"/></td>
  </tr>
  <tr>
     <td><span>Teacher Remarks:*</span></td>
  <td><input type="text" name="Nteacher_remarks" value="<?php echo $row['teacher_remarks'];?>"/></td>
  </tr>

  <tr>
     <td><span>Student Feedback:*</span></td>
  <td><input type="text" name="Nstudent_feedback" value="<?php echo $row['student_feedback'];?>"/></td>
  </tr>
