...
$result=mysqli_query($conn,"SELECT * FROM salaryrecord WHERE scardno='$scardno'");
...
if(isset($_POST['update'])){
 ...
 $role=$_POST['Nrole'];
 $receivername=$_POST['Nreceivername'];
 $amount_received=$_POST['Namount_received'];
 $status=$_POST['Nstatus'];
 $datereceived=$_POST['Ndatereceived'];
$ro=$row['scardno'];

$update=mysqli_query($conn,"UPDATE salaryrecord SET scardno='$scardno',category='$category',role='$role',receivername='$receivername',amount_received='$amount_received',status='$status',datereceived='$datereceived' WHERE scardno= '$ro'");
if($update){
...
<table style="text-align: ceter; margin: 0 auto; margin-top:50px;">
  <tr>
  ...
  <td>
  <input type="text" name="Ncategory" value="<?php echo $row['category'];?>"/></td>
  </tr>
  <tr>
     <td><span>Role:*</span></td>
  <td><input type="text" name="Nrole" value="<?php echo $row['role'];?>"/></td>
  </tr>

  <tr>
     <td><span>Receiver Name :*</span></td>
  <td><input type="text" name="Nreceivername" value="<?php echo $row['receivername'];?>"/></td>
  </tr>
  <tr>
     <td><span>Amount Received:*</span></td>
  <td>
  <input type="text" name="Namount_received" value="<?php echo $row['amount_received'];?>"/></td>
  </tr>
  <tr>
  ...
  <td><input type="text" name="Ndatereceived" value="<?php echo $row['datereceived'];?>"/></td>
  </tr>
