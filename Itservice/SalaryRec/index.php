...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="col-sm-12 col-sm-offset-12 col-md-10 col-md-offset-2 main" style="padding-top: 70px;">
            ...
            <a href="create.php" id="add">Add New Record</a>
...
<table style="text-align: ceter; margin: 0 auto; margin-top:50px;">
 ...
 while($row=$result->fetch_array()){?>
  ...
  <td><?php echo $row['datereceived'];?></td>
   <td><a href="update.php?scardno=<?php echo $row['scardno'];?>">Update</a></td>
  <td><a href="delete.php?scardno=<?php echo $row['scardno'];?>">Delete</a></td>
