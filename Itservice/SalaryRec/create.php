...
if(empty($_POST['scardno'])| empty($_POST['amount_received'])){
...
$query = "insert into salaryrecord values('$scardno','$category','$role','$receivername','$amount_received','$status','$datereceived')";
...
<tr>
  ...
  <td><input type="text" name="amount_received"/></td>
  </tr>
  <tr>
  ...
  <td><input type="text" name="datereceived"/></td>
  </tr>
