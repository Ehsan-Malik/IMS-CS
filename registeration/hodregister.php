...
if (isset($Register)) {
    ...
    if ($r == true) {
        ...
        $query = "insert into registration values('','$fname','$lname','$dob','$USN','$mail','','$cnic','$cardno','$gen','$phone','$image1','$pass','', '','', '$ques', '$ans', 'Hod')";
        $data = mysqli_query($con, $query);


        $query = "insert into hod values('$cardno','$fname','$lname','$USN','$pass','$phone','$cnic')";
...
<nav id="navigation" class="navbar navbar-expand-lg navbar-dark" style="background-color: #5239aa; ">
    ...
    <div class=" mcontainer">
        <form name="register" method="post" class="myform" action="" enctype="multipart/form-data">
            <h1 class="tit">HOD Registration</h1>
            <?php echo @$err; ?>
