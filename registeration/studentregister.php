...
if (isset($Register)) {
    ...
    if ($r == true) {
        ...
        $query = "insert into registration values('','$fname','$lname','$dob','$USN','$mail','$rollno','$cnic','','$gen','$phone','$image1','$pass','', '$dis','$sem', '$ques', '$ans', 'Student')";
        $data = mysqli_query($con, $query);

        
        $query = "insert into student values('$rollno','$fname','$lname','$USN','$mail','$pass','$cnic','$phone','','$dis','$sem')";
        ...
        if ($data) {
            ...
            $err = "<font color='red'> Not Registered Problems in Registeration...!!</font>";
        }
    }
}
?>
...
<body>
    ...
    <div class=" mcontainer">
        <form name="register" method="post" class="myform" action="" enctype="multipart/form-data">
            <h1 class="tit">Student Registration</h1>
            <?php echo @$err; ?>
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="td1">
                    <input type="number" name="rollno" autocomplete="off" placeholder="3565" required />
                ...
                <tr>
                    <td>
                        <label class="label required">Discipline</label>
                    </td>
                    <td>
                    ...
                    <td class="td1">
                        ...
                        <select name="dis" autocomplete="off" class="select12" placeholder="" required>
                            <option name="s1"> Computer Science </option>
                            <option name="s2"> Software Engineering </option>
                ...
                <tr>
                    ...
                    <td class="td1">
                        ...
                        <select name="sem" autocomplete="off" class="select12" placeholder="" required>
                            ...
                            <option name="s5" selected> 5 </option>
