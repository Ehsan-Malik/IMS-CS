...
if (isset($Register)) {
    ...
    if ($r == true) {
        ...
        $query = "insert into registration values('','$fname','$lname','$dob','$USN','$mail','','$cnic','$cardno','$gen','$phone','$image1','$pass','$cat', '','', '$ques', '$ans', 'IT Services Staff')";
        $data = mysqli_query($con, $query);



        $query = "insert into itservice values('$cardno','$fname','$lname','$USN','$pass','$mail','$cnic','$cat','$phone')";
...
float:left;
  ...
  /*End of  footer*/
    ...
    <title>IT Services Registration</title>
</head>
...
<body>
    ...
    <div class=" mcontainer">
        <form name="register" method="post" class="myform" action="" enctype="multipart/form-data">
            <h1 class="tit">IT Services Staff Registration</h1>
            <?php echo @$err; ?>
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="td1">
                    <br>
                        <input type="radio" name="cat" value="Clerk" />&nbsp;&nbsp;&nbsp;&nbsp;Clerk
                    <br>
                    <br>
                        <input type="radio" name="cat" value="Data Operator" />&nbsp;&nbsp;&nbsp;&nbsp;Data Operator<br>
