...
if (isset($Upload)) {
    //check user alereay exists or not
        ...
        $query = "insert into s_assignment (id, rollno, file) values('$id','$rollno','$file')";
        $data = mysqli_query($con, $query);
        if ($data) {
            $err = "<font color='green'>Uploaded successfully...!!</font>";
            
        
        move_uploaded_file($_FILES['file']['tmp_name'], "../../../Teacher/AssignmentRec/Check/files/" . $_FILES['file']['name']);
        }
}
else{
    echo "Loading Server Busy";
}     
}
?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="col-sm-12 col-sm-offset-12 col-md-10 col-md-offset-2 main" style="padding-top: 70px;">
            ...
            <h1 class="tit">Assignment Upload</h1>
            <?php echo @$err; ?>
           
            <table width="100%">
                <tr>
                    <td>
                        <label class="label required">Assignment ID</label>
                    </td>
                    ...
                    <td class="td1">
                        <input type="number" autocomplete="off" name="id" placeholder="Assignment ID" class="required" required />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="text" name="rollno" autocomplete="off" placeholder="Roll Number" required />
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <label class="label required">Upload Your Assignment</label>

                    </td>
                    <td> </td>
                    <td><input class="form-control" type="file" name="file" id="img" /></td>
                </tr>

                    <tr>
                    <td>
                        <input type="submit" name="Upload" class="login_btn" value="Upload" />
                    </td>
                    <td>
