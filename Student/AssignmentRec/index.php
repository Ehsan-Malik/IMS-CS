...
<body>
  ...
  <div class="card-body">
    ...
    <p class="card-text">Is any Assigments are to be submitted. You can Submit it below.</p>
    <a href="http://localhost/IMS/Student/AssignmentRec/Upload" class="btn btn-primary">Submit Assignment</a>
  </div>
...
<div class="card text-center" id="cardcenter">
  ...
  <div class="card-body">
    <h5 class="card-title">Check New Assignments</h5>
    <p class="card-text">Is there any new assignment to submit. You can check it below.</p>
    <a href="http://localhost/IMS/Student/AssignmentRec/Check" class="btn btn-primary">Check New Assignments</a>
  </div>
  <div class="card-footer text-muted" style="background-color:blue;">
