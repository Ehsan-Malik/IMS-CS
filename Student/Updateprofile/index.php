...
<body>
    ...
    extract($_POST);
    if (isset($Update)) {
        $q = "UPDATE student set rollno= '$rollno',fname = '$fname',lname = '$lname',phno = '$phone',cnic='$cnic',email='$email' where usn = '$user'";
        $run = mysqli_query($conn, $q);
        $q = "UPDATE registration set roll= '$rollno',fname = '$fname',lname = '$lname',bdate = '$dob',phno = '$phone',cnic='$cnic',email='$email',question='$question',answer='$answer' where usn = '$user'";
        $run = mysqli_query($conn, $q);
        if ($run) {
        ...
        <form name="register" method="post" class="myform" action="" enctype="multipart/form-data">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="text" name="rollno" value="<?php echo $row['roll']; ?>"  />
                    </td>
                </tr>
